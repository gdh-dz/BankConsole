...
public class User{ //definición de la clase, user es la entidad con sus atributos
    [JsonProperty]
    protected int ID{get; set; }  //public es el tipo de acceso, tipo de dato y nombre del atributo
    [JsonProperty]
